...
<script type="text/javascript" src="js1/jquery.mmenu.js"></script>
  ...
  <?php  
  $min = (isset($_POST['minP']) ? $_POST['minP'] : null);
  $max = (isset($_POST['maxP']) ? $_POST['maxP'] : null);
			...
			<div id="sidebar">
			  ...
			  <div class="box search">
				...
				<div class="box-content">
				  <form action="SSearchResult.php" method="post">
					<label>Keyword</label>
                  ...
                  <div id="content">
					<div id="products">
                      <ul >
						...
						if ($min!="" AND $max!="")
							{
							$query=mysqli_query($conn,"Select * FROM Inventory WHERE UpdatedPrice BETWEEN $min AND $max");
							}
						else if ($min!="" AND $max=="")
						{
							$query=mysqli_query($conn,"Select * FROM Inventory WHERE UpdatedPrice > $min");
						}
						else if ($min=="" AND $max!="")
						{
							$query=mysqli_query($conn,"Select * FROM Inventory WHERE UpdatedPrice < $max");
						}
						else if ($min=="" AND $max=="")
							$query=mysqli_query($conn,"Select * FROM Inventory WHERE Category LIKE '%$searchq%' OR SubCategory LIKE '%$searchq%' OR ProductName LIKE '%$searchq%' OR Description LIKE '%$searchq%' OR Brand LIKE '%$searchq%' OR SellerName LIKE '%$searchq%'");
