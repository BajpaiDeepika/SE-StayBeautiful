                        ...
                        <div class="col-md-5 col-md-offset-4">
                        	...
                        	<div class="form-box">
	                            ...
	                            <div class="form-bottom">
				                    <form class="form-horizontal" id="form_members" role="form" action="sp1.php" method="POST">	
										
									<?php if (isset($_GET['err'])) { ?>
										<div class="alert alert-danger text-center"><?php echo "Invalid Details"; ?></div>
									<?php } ?>
	
										<div class="form-group">
											<label for="secretquestion">Select a Secret Question?</label>
											<div>
												<select class="form-control" name="secretquestion" id="secretquestion">
										...
										<label for="secretanswer">Secret Answer</label></br>
											<div>
												<input type="text" class="form-control" name="secretanswer" id="secretanswer" placeholder="Enter your Secret Answer!">
											</div>
										</div>
										<div class="form-group">
