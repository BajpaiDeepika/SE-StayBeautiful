...
<div class="header_btm">
  ...
  <!-- Start slider -->
			<section>
				<br>
  <h3 style="color:purple";><strong><center>Reports</center></strong></h3>
  <form action="PurchaseReport.php" method="POST">
 
  <?php $ID=($_GET['user_id']); ?>
  <input type="hidden" name="ID" value=<?php echo $ID; ?>>
  <center><button class="button" type="submit" value="Report">Purchase Report</button></center>
  </form>
  <?php
	$db_host = "localhost"; 
	$db_username = "root";   
	...
	$query="Select username FROM members1 where userid={$_GET['user_id']} limit 1";
	...
	if($result = $conn1->query("SELECT address,city,state,zip,phone FROM members1 where userid=$ID"))
	{
  ...
  <?php
  echo "<center><a href=BuyerInformationUpdate.php?ID=$ID>Update Personal Information</a>";
  ?>
